...
def calculate_demographic_data(print_data=True):
    ...
    total_bachelors = df.loc[df['education'] == 'Bachelors'].shape[0]
    ...
    rich_people_min_workers = num_min_workers.loc[num_min_workers['salary'] == '>50K']
    
    rich_percentage = rich_people_min_workers.shape[0] / num_min_workers.shape[0] * 100
